...
if paused {
	if !surface_exists(paused_surf) {
		...
		if not dialog_pause {
			...
			var buttonx1 = camera_get_view_width(0)/2-64;
			var buttony1 = camera_get_view_height(0)/2-16;
			var buttonx2 = camera_get_view_width(0)/2+64;
			var buttony2 = camera_get_view_height(0)/2+16;
			draw_rectangle(buttonx1, buttony1, buttonx2, buttony2, true);
			draw_set_color(c_white);
			draw_text(camera_get_view_width(0)/2 - string_width("EXIT")/2, camera_get_view_height(0)/2 - string_height("EXIT")/2, "EXIT");
